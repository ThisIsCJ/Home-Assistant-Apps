...
Dark-only theme. All colors are CSS custom properties on `:root`.
...
2. **Blue accent everywhere interactive** — hover states, active nav, focus rings, and primary buttons all use the blue family.
