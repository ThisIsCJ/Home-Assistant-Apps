...
export const Icons = {
  ...
  GitCommit:    i(<><circle cx="12" cy="12" r="4"/><line x1="1.05" y1="12" x2="7" y2="12"/><line x1="17.01" y1="12" x2="22.96" y2="12"/></>),
  ...
  DownloadCloud:i(<><polyline points="8 17 12 21 16 17"/><line x1="12" y1="12" x2="12" y2="21"/><path d="M20.88 18.09A5 5 0 0 0 18 9h-1.26A8 8 0 1 0 3 16.29"/></>),
  History:      i(<><path d="M1 4v6h6"/><path d="M3.51 15a9 9 0 1 0 2.13-9.36L1 10"/><polyline points="12 7 12 12 15 15"/></>),
  Bold:         i(<><path d="M6 4h8a4 4 0 0 1 4 4 4 4 0 0 1-4 4H6z"/><path d="M6 12h9a4 4 0 0 1 4 4 4 4 0 0 1-4 4H6z"/></>),
  Italic:       i(<><line x1="19" y1="4" x2="10" y2="4"/><line x1="14" y1="20" x2="5" y2="20"/><line x1="15" y1="4" x2="9" y2="20"/></>),
  Underline:    i(<><path d="M6 3v7a6 6 0 0 0 6 6 6 6 0 0 0 6-6V3"/><line x1="4" y1="21" x2="20" y2="21"/></>),
  Strikethrough:i(<><path d="M17.3 5H8.7a3.2 3.2 0 0 0-1 6.2"/><path d="M8 19h7.3a3.2 3.2 0 0 0 1.6-6"/><line x1="4" y1="12" x2="20" y2="12"/></>),
  Subscript:    i(<><path d="M4 5l8 10"/><path d="M12 5L4 15"/><path d="M16 19h4l-4 0c2.5-2 4-3.2 4-4.6a1.8 1.8 0 0 0-3.5-.6"/></>),
  Superscript:  i(<><path d="M4 9l8 10"/><path d="M12 9L4 19"/><path d="M16 9h4l-4 0c2.5-2 4-3.2 4-4.6a1.8 1.8 0 0 0-3.5-.6"/></>),
  AlignLeft:    i(<><line x1="17" y1="10" x2="3" y2="10"/><line x1="21" y1="6" x2="3" y2="6"/><line x1="21" y1="14" x2="3" y2="14"/><line x1="17" y1="18" x2="3" y2="18"/></>),
  AlignCenter:  i(<><line x1="18" y1="10" x2="6" y2="10"/><line x1="21" y1="6" x2="3" y2="6"/><line x1="21" y1="14" x2="3" y2="14"/><line x1="18" y1="18" x2="6" y2="18"/></>),
  AlignRight:   i(<><line x1="21" y1="10" x2="7" y2="10"/><line x1="21" y1="6" x2="3" y2="6"/><line x1="21" y1="14" x2="3" y2="14"/><line x1="21" y1="18" x2="7" y2="18"/></>),
  AlignJustify: i(<><line x1="21" y1="10" x2="3" y2="10"/><line x1="21" y1="6" x2="3" y2="6"/><line x1="21" y1="14" x2="3" y2="14"/><line x1="21" y1="18" x2="3" y2="18"/></>),
  Eraser:       i(<><path d="M20 20H7L3 16a2 2 0 0 1 0-2.8l9.6-9.6a2 2 0 0 1 2.8 0l5 5a2 2 0 0 1 0 2.8L13 19"/><line x1="6" y1="11" x2="13" y2="18"/></>),
...
export function StatusIcon({ status, size = 14 }) {
  const map = {
    ready:   { icon: Icons.CheckCircle,   color: 'var(--green2)' },
    pushed:  { icon: Icons.CheckCircle,   color: 'var(--green2)' },
    error:   { icon: Icons.XCircle,       color: 'var(--red)' },
    failed:  { icon: Icons.XCircle,       color: 'var(--red)' },
    cloning: { icon: Icons.Loader,        color: 'var(--accent2)', spin: true },
    warning: { icon: Icons.AlertTriangle, color: 'var(--orange)' },
  };
  const { icon: Icon, color, spin } = map[status] || map.warning;
